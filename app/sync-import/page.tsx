...
// QR deep-link import page (Opción B — self-contained claim). The export QR on
...
// On close the page navigates back to '/' — the app remounts and boots from
// the freshly persisted localStorage blob (pattern de la era localStorage).
